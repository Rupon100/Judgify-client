        ...
        <div className="p-10 flex gap-6 flex-col justify-center items-center" >
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3" >
                <div className='space-y-2 bg-slate-200 p-3 rounded-lg ' >
                    <img className='w-20' src={hero} alt="herp there" />
                ...
                <div className='space-y-2 bg-slate-200 p-3 rounded-lg ' >
                    <img className='w-20' src={hubSport} alt="hubspot there" />
                ...
                <div className='space-y-2 bg-slate-200 p-3 rounded-lg ' >
                    <img className='w-20' src={googleReview} alt="google review there" />
                ...
                <div className='space-y-2 bg-slate-200 p-3 rounded-lg ' >
                    <img className='w-20' src={birdEye} alt="bird eye there" />
                ...
                <div className='space-y-2 bg-slate-200 p-3 rounded-lg ' >
                    <img className='w-20' src={yelp} alt="yelp there" />
                ...
                <div className='space-y-2 bg-slate-200 p-3 rounded-lg ' >
                    <img className='w-20' src={trustPilot} alt="herp there" />
